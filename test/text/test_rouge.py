...
from test.text.inputs import Input, _inputs_multiple_references, _inputs_single_sentence_single_reference
...
def test_rouge_lsum_score(pl_rouge_metric_key, use_stemmer):
    """Specific test to verify the correctness of Rouge-L and Rouge-LSum metric."""
    rouge_level, metric = pl_rouge_metric_key.split("_")
    original_score = _compute_rouge_score(
