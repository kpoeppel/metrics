...
from test.text.helpers import TextTester
from test.text.inputs import _inputs_single_reference, _inputs_single_sentence_multiple_references
...
def rwth_manual_metric(preds, targets) -> Tensor:
    ...
    the examples defined in `test.text.inputs` with the script from https://github.com/rwth-i6/ExtendedEditDistance.
    """
