...
from test.helpers import seed_all
from test.helpers.testers import Metric, MetricTester
from test.retrieval.inputs import _input_retrieval_scores as _irs
from test.retrieval.inputs import _input_retrieval_scores_all_target as _irs_all
from test.retrieval.inputs import _input_retrieval_scores_empty as _irs_empty
from test.retrieval.inputs import _input_retrieval_scores_extra as _irs_extra
from test.retrieval.inputs import _input_retrieval_scores_float_target as _irs_float_tgt
from test.retrieval.inputs import _input_retrieval_scores_for_adaptive_k as _irs_adpt_k
from test.retrieval.inputs import _input_retrieval_scores_int_target as _irs_int_tgt
from test.retrieval.inputs import _input_retrieval_scores_mismatching_sizes as _irs_mis_sz
from test.retrieval.inputs import _input_retrieval_scores_mismatching_sizes_func as _irs_mis_sz_fn
from test.retrieval.inputs import _input_retrieval_scores_no_target as _irs_no_tgt
from test.retrieval.inputs import _input_retrieval_scores_with_ignore_index as _irs_ii
from test.retrieval.inputs import _input_retrieval_scores_wrong_targets as _irs_bad_tgt
...
def _concat_tests(*tests: Tuple[Dict]) -> Dict:
    """Concat test composed by a string and a list of arguments."""
    assert len(tests), "`_concat_tests` expects at least an argument"
    assert all(tests[0]["argnames"] == x["argnames"] for x in tests[1:]), "the header must be the same for all test"
