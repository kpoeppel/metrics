...
from test.classification.inputs import _input_binary, _input_binary_logits, _input_binary_prob
from test.classification.inputs import _input_multiclass as _input_mcls
from test.classification.inputs import _input_multiclass_logits as _input_mcls_logits
from test.classification.inputs import _input_multiclass_prob as _input_mcls_prob
from test.classification.inputs import _input_multiclass_with_missing_class as _input_miss_class
from test.classification.inputs import _input_multidim_multiclass as _input_mdmc
from test.classification.inputs import _input_multidim_multiclass_prob as _input_mdmc_prob
from test.classification.inputs import _input_multilabel as _input_mlb
from test.classification.inputs import _input_multilabel_logits as _input_mlb_logits
from test.classification.inputs import _input_multilabel_multidim as _input_mlmd
from test.classification.inputs import _input_multilabel_multidim_prob as _input_mlmd_prob
from test.classification.inputs import _input_multilabel_prob as _input_mlb_prob
from test.helpers import seed_all
from test.helpers.testers import NUM_BATCHES, NUM_CLASSES, THRESHOLD, MetricTester
...
def test_class_not_present(metric_class, metric_fn, ignore_index, expected):
    """This test that when metric is computed per class and a given class is not present in both the `preds` and
