...
from test.classification.inputs import _input_binary_prob_plausible as _input_binary_prob_ok
from test.classification.inputs import _input_multilabel_prob as _input_mlb_prob
from test.classification.inputs import _input_multilabel_prob_plausible as _input_mlb_prob_ok
