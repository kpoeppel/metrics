...
from test.classification.inputs import Input
from test.classification.inputs import _input_binary as _bin
from test.classification.inputs import _input_binary_prob as _bin_prob
from test.classification.inputs import _input_multiclass as _mc
from test.classification.inputs import _input_multiclass_prob as _mc_prob
from test.classification.inputs import _input_multidim_multiclass as _mdmc
from test.classification.inputs import _input_multidim_multiclass_prob as _mdmc_prob
from test.classification.inputs import _input_multilabel as _ml
from test.classification.inputs import _input_multilabel_multidim as _mlmd
from test.classification.inputs import _input_multilabel_multidim_prob as _mlmd_prob
from test.classification.inputs import _input_multilabel_prob as _ml_prob
from test.helpers import seed_all
from test.helpers.testers import BATCH_SIZE, EXTRA_DIM, NUM_BATCHES, NUM_CLASSES, THRESHOLD
