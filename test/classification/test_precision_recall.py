...
def test_no_support(metric_class, metric_fn):
    """This test a rare edge case, where there is only one class present.
...
def test_top_k(
    ...
    Just a sanity check, the test in StatScores should already guarantee the correctness of results.
    """
